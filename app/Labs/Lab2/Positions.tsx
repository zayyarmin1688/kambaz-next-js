    ...
    <>
      <div id="wd-css-position-relative">
        ...
        <div className="wd-bg-color-gray">
          <div className="wd-dimension-portrait wd-bg-color-yellow wd-pos-relative-nudge-down-right">
            Portrait
          </div>
          <div className="wd-dimension-landscape wd-bg-color-blue wd-fg-color-white wd-pos-relative-nudge-up-right">
            Landscape
          </div>
